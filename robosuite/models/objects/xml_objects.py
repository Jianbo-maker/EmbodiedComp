...
class BowlObject(MujocoXMLObject):
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/akita_black_bowl/akita_black_bowl.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class JuiceObject(MujocoXMLObject):
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/orange_juice/orange_juice.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
        )
class SoupObject(MujocoXMLObject):
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/alphabet_soup/alphabet_soup.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class MugObject(MujocoXMLObject):
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/red_coffee_mug/red_coffee_mug.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class KetchupObject(MujocoXMLObject):
    """
    Ketchup object
    """
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/ketchup/ketchup.xml"), name=name, obj_type="all", duplicate_collision_geoms=True
        )
    @property
...
class ButtonObject(MujocoXMLObject):
    def __init__(self, name):
        super().__init__(xml_path_completion("objects/button.xml"), name=name, joints=[dict(type="slide", axis=[0,0,1], damping="0.001")], obj_type="all",duplicate_collision_geoms=True,)

    @property
    def important_sites(self):
        dic = super().important_sites
        dic.update({"horizontal_radius": self.naming_prefix + "horizontal_radius"})
        return dic
