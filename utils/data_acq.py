...
if __name__ == "__main__":
    ...
    env=Pi0UR5DataWrapper(env,"data/test",prompt="pick up the red cube")
    ...
    while True:
        ...
        while not done:
            ...
            obs,_,_,info=env.step(env_action)
            # print(f"obs:{obs['robot0_gripper_qpos']}")

            # print(f"states{env.sim.get_state().flatten()}")
            env.render()
            done=env._check_success() and info["ifdone"]
