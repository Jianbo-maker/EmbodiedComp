...
def ur5_dataset_transform(trajectory:Dict[str, Any]) -> Dict[str, Any]:
    gripper_action = trajectory["action"][:, -1:]
    gripper_action = invert_gripper_actions(tf.clip_by_value(gripper_action, 0, 1))
    ...
    trajectory["observation"]["EEF_state"] = trajectory["observation"]["state"][:, :6]
    trajectory["observation"]["gripper_state"] = trajectory["observation"]["state"][:, -1:]  # 1D gripper state
    return trajectory
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    #ur5 dataset
    "robosuite_rlds": ur5_dataset_transform,
    "robosuite_ur5": ur5_dataset_transform,
}
